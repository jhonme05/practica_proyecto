    ...
    <div class="card-body">
      ...
      <form method="post">
        <?php
          if(isset($_GET["m"])){
            switch($_GET["m"]){
              case "1";
              ?>
              <div class="alerta alert-danger" role="alert">
              ...
              case "2";
              ?>
              <div class="alerta alert-warning" role="alert">
        ...
        <div class="input-group mb-3">
          <input type="email" name="correo" id="usuario_correo" class="form-control" placeholder="Email">
